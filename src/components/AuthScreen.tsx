...
export function AuthScreen() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-tr from-indigo-600/20 via-purple-600/20 to-pink-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="bg-slate-900/90 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-slate-400 mt-2 leading-relaxed">
              Discover how friends perceive you & who you are most similar to
            </p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-950/80 border border-slate-800 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    maxLength={6}
                    className="w-full bg-slate-950/80 border border-slate-800 rounded-xl py-3 pl-10 pr-4 text-sm text-center font-mono tracking-widest text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                  />
                </div>
              </div>
        ...
        {/* Big 5 Explanation Card */}
        <div className="bg-slate-900/60 border border-slate-800/80 rounded-3xl p-5 space-y-3">
          <div className="text-xs font-bold text-slate-200 flex items-center gap-2">
            <Brain className="w-4 h-4 text-indigo-400" />
            <span>Why Big 5 Personality Comparisons?</span>
          </div>
          <div className="grid grid-cols-1 gap-2 text-[11px] text-slate-400">
            <div className="flex items-start gap-2">
              <Eye className="w-3.5 h-3.5 text-purple-400 shrink-0 mt-0.5" />
              <span><strong>See How Others Perceive You:</strong> Discover group consensus on your core traits.</span>
            </div>
            <div className="flex items-start gap-2">
              <HeartHandshake className="w-3.5 h-3.5 text-emerald-400 shrink-0 mt-0.5" />
              <span><strong>Find Personality Match:</strong> See which friends share your personality profile and trait alignment.</span>
            </div>
          </div>
        </div>
      </div>
